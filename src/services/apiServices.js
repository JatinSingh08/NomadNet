...
import { BOOKMARK_A_POST, DISLIKE_A_POST, EDIT_POST, EDIT_PROFILE, FOLLOW_A_USER, GET_ALL_USERS, GET_POSTS_BY_USERNAME, LIKE_A_POST, LOGIN, POSTS, REMOVE_BOOKMARKED_POST, SIGNUP, UNFOLLOW_A_USER } from "./apiUrls";

export const loginService = (username, password) => axios.post(LOGIN, {
  username, 
  password
})

export const signupService = (userInfo) => axios.post(SIGNUP, {
  ...userInfo
})
...
export const createPostService = (encodedToken, postData) => axios.post(
  POSTS,
  { postData },
  {
    headers: {
